# Generated by Django 2.2.1 on 2019-05-15 22:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comics', '0004_change_image_upload_to'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='arc',
            name='cvid',
            field=models.PositiveIntegerField(blank=True, null=True, unique=True, verbose_name='Comic Vine ID'),
        ),
        migrations.AlterField(
            model_name='creator',
            name='cvid',
